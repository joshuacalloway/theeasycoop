...
case class BulkitemOrder(id: Pk[Long] = null, bulkitem_id: Int, minimumbuyers: Int, deadline_by: Date, deliveryaddress: String, created_at: Date, created_by_id: Int, coop_id: Int) extends AbstractModel {
...
object BulkitemOrder {
  ...
  val mapping = {
    ...
    get[Int]("coop_id") map {
      case id~bulkitem_id~minimumbuyers~deadline_by~deliveryaddress~created_at~created_by_id~coop_id => BulkitemOrder(id,bulkitem_id,minimumbuyers,deadline_by,deliveryaddress,created_at,created_by_id,coop_id)
  ...
  def create(item: BulkitemOrder) {
    DB.withConnection { implicit c =>
      SQL("insert into bulkitemorder (bulkitem_id,minimumbuyers,deadline_by,deliveryaddress,created_at,created_by_id,coop_id) select {bulkitem_id},{minimumbuyers},{deadline_by},{deliveryaddress},{created_at},{created_by_id},{coop_id}").on(
